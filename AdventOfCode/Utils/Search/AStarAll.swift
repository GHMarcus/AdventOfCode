...
/**
 The A* search all algorithm.
 Finds all shortest/cheapest path from `start` to `goal`
 ...
 - Returns: The all shortest/cheapest paths from `start` to `goal`,
 or nil if no such path exists.
 */
public func aStarAll<Node: Hashable, S: Sequence<Node>>(
    start: Node,
    goal: Node,
